...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let btn2 = UIButton(frame: CGRect(x: 50, y: 400, width: 50, height: 50))
        ...
        let btn3 = UIButton(frame: CGRect(x: 50, y: UIScreen.main.bounds.height - 150, width: 50, height: 50))
        ...
        let btn4 = UIButton(frame: CGRect(x: UIScreen.main.bounds.width - 100, y: 100, width: 50, height: 50))
        ...
        let btn5 = UIButton(frame: CGRect(x: UIScreen.main.bounds.width - 100, y: 400, width: 50, height: 50))
        ...
        let btn6 = UIButton(frame: CGRect(x: UIScreen.main.bounds.width - 100, y: UIScreen.main.bounds.height - 150, width: 50, height: 50))
